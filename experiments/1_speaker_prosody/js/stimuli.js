...
{audio_target: "anxious",
  ...
  icontext: "Mike is a doctor and runs into Julie on his way home. He briefly tells Julie about one of his patients that day, who had several broken bones. Several days later, Julie goes out to eat with her boyfriend Stan. Stan asks about Mike. Julie tells him about what she recalls her brief encounter with him.", 
  kcontext: "Mike visited Julie at work to bring her something to eat. Julie is a doctor at a nearby hospital. Mike has to go back home, but Julie had to return to the hospital to see one last patient who suffered an injury with several broken bones. Upon getting home, Mike asks Julie about her last patient.", 
  ...
  icontext: "Mike tells Julie that his sister is in town visiting. Julie hasn’t met her yet. She’s only seen a blurry picture of her on Facebook. Later, Julie gets lunch with her boyfriend Stan. Stan's friend is looking for a blind date and Stan heard about Mike's sister being in town. Stan asks Julie what she knows about Mike's sister.", 
  kcontext: "Julie’s sister is in town visiting and they spent the day shopping and getting their hair done. Julie's sister is currently between relationships and want to go out on a date during her visit. During a break at work, Julie has a coffee with Mike and asks him whether some of his single friends that might be interested in a blind date. Mike hasn't seen Julie's sister and asks Julie several questions about her.", 
...
//target dirty
  {audio_target: "dirty",
  audio_filler: "filthy",
  icontext: "Mike had to go out of town on a business trip for 10 days and gave his brother a key to his house to water his plants and feed his cats. Upon coming back, he noticed that his brother might have had a party in his apartment. Julie called Mike when he got back to invite him out for drinks and Mike quickly told her over the phone what had happened.", 
  kcontext: "Julie went back-packing in Vietnam for two months and sublet her apartment to a friend of a work colleague. Upon coming back, she found her apartment not in the state that it was in when she left. She reckoned that the person that sublet her apartment had a big party prior to moving out. Julie called Mike and told him what happened.", 
  question: "Did Julie notice that her apartment was not clean?",  
  speakerutt: "then asks Julie:", 
...
//target good-looking
  ...
  audio_filler: "hot",
  icontext: "Mike and Julie meet for lunch. Mike, who recently got out of a long term relationship, lost a lot of weight and changed his look. He tells Julie about his date yesterday. A couple of day later, on her way home, Julie is on the phone with her boyfriend Stan and tells him about Stan's tranformation and how is going out on a lot of dates. Suprised, Stan asks about Mike's date and Julie briefly tells Stan what she gathered from her conversation with Mike.", 
...
// target intelligent
  ...
  icontext: "Mike recently went back to school at the local community college to strengthen his computer programming ability. One day after class, he runs into Julie briefly on the bus and tells her about one of his classes. Upon getting home later that night, Julie tells Stan about her run-in with Mike on the bus and what she remembers from her conversation with him. ", 
...
// target intimidating
  ...
  icontext: "Mike is an amateur kickboxer. After a recent competition, he sees his friend Julie in a noisy bar and briefly tells her about his last fight that he lost. Upon getting home, Stan asks how Mike is doing. Julie tells him what she remembers about what Mike said about his kickboxing fight.", 
  ...
  kcontext: "As president of the student body, Julie gives a speech to all of the current graduates. She had given it a considerable amount of work and had practiced it several times. Later that night after giving the speech, Mike and Julie meet up for drinks and told him how it went.", 
 ...
 // target prominent
  ...
  audio_filler: "famous",
  icontext: "Mike has a new internship at a law firm, one of the best in the city, and tells Julie about it over Facebook. He doesn't really mention many details, besides that he was quite anxious on his first day given the prestige of the firm. Later on, she hangs out with her boyfriend Stan and tells Stan about her brief chat with Mike.", 
  kcontext: "Julie has a new internship at a law firm, one of the best in the city. Because there was a lot competition to get the position, she was quite anxious about her first day. After work, she meets up with and tells her about it.", 
...
// target serious
  ...
  kcontext: "Julie had started having headaches and felt weak. She found herself stuck in bed. Concerned for health, her roomate took her to the emergency room. It took the doctors several weeks to diagnose her with mono and provide a treatment for her. After she feels better, she meets up with her friend Mike and tells him what happened.", 
...
// target shabby
  ...
  icontext: "Several months after his uncle passed away, Mike goes to see his house in the next state over and help prepare it to be sold. On his way back, he sees his friend Julie at the grocery store and briefly tells her about it. Upon getting home, Julie tells her boyfriend Stan what she gathered about Mike's uncle's house.", 
...
{audio_target: "strenuous",
  ...
  kcontext: "Julie is having dinner with Mike. Mike asks Julie what she did today and she tells him that she and her boyfriend Max went on a hike.", 
...
// target ugly
  ...
  kcontext: "Julie’s sister is getting married, and Julie is a bridesmaid. Her sister is a bit younger than her and they have different tastes in clothes. Because Julie was out of town on a business trip, her sister and her friends picked out several types of the bridesmaids' dresses and Julie had to choose amongst the preselected dresses. The next day, Julie tells her friend Mike about the wedding preparations.", 
...
// target understandable
  ...
  icontext: "Mike had an important interview at for a job in communications. As part of his interview, Mike had to give a speech explaining several complicated scientifc findings as part of a mock press conference. A couple of weeks prior to the interview, Julie, Mike's friend, had given Mike some tips about presenting in high stress situations and was interested in how it went. She texted Mike after the interview and he said it went well. Later, when Julie gets home, she tells her boyfriend Stan about her brief chat with Mike.", 
  kcontext: "Julie had an important interview at at for a job in communications. As part of her interview, Julie had to give a speech explaining several complicated scientifc findings as part of a mock press conference. After the interview, she met up with friend Mike, who had helped her prepare for the interview, for a coffee and told him how her interview went.", 
...
// target unpleasant
  ...
  kcontext: "Julie, remembering her second year in college, tells Mike about her first apartment that he moved into after leaving the dorms. It was very basic and had a mold problem in the kitchen and the bathroom.", 
...
// target hungry
  ...
  icontext: "Mike forgets to feed the dog in the morning before he goes to work. Upon arriving work, he calls his roommate to do it and if the dog is ok. At lunch, he tell Julie about forgeting to feed his dog. Later that night at home, Julie tells Stan about what she heard about Mike’s dog situation", 
...
{audio_target: "cheap",
  ...
  kcontext: "Julie had just lost her phone and in order to be able to afford a replacement, she needed to sign up for a new cellphone plan. Her friend Mike is looking for a new cellphone plan as well and asks her about her cell new phone plan.",
...
{audio_target: "guilty",
  ...
  speakerutt: "then asks Julie:", 
  kexchange: "Mike: Was your sister",
  iexchange: "Stan: Was his sister",
  answer: "Julie: <strong>She was",
