...
//target anxious
  ...
  kexchange:: "Mike: Was your patient hysterical?<br>Julie: <strong>She was anxious.</strong>",
  iexchange:: "Stan: Was his patient hysterical?<br>Julie: <strong>She was anxious.</strong>",
  kresponsequestion: "Does Julie mean that her patient was hysertical?",
  iresponsequestion: "Does Julie mean that his patient was hysertical?"}
...
{audio_filler: "hysterical",
  ...
  question: "Did Julie treat a patient that day?",  
  speakerutt: "then asks Julie:", 
  kexchange:: "Mike: Was your patient anxious?<br>Julie: <strong>She was hysterical.</strong>",
  iexchange:: "Stan: Was his patient anxious?<br>Julie: <strong>She was hysterical.</strong>",
  kresponsequestion: "Does Julie mean that her patient was anxious?",
  iresponsequestion: "Does Julie mean that his patient was anxious?"}
 ...
 //target attractive
  ...
  speakerutt: "then asks Julie:", 
  kexchange:: "Mike: Is your sister beautiful?<br>Julie: <strong>She's attractive.</strong>",
  iexchange:: "Stan: Is his sister beautiful?<br>Julie: <strong>She's attractive.</strong>",
  kresponsequestion: "Does Julie mean that her sister is beautiful?",
  iresponsequestion: "Does Julie mean that his sister is beautiful?"}
...
//target dirty
  ...
  speakerutt: "then asks Julie:", 
  kexchange:: "Mike: Was your carpet filthy?<br>Julie: <strong>It was dirty.</strong>",
  iexchange:: "Stan: Was his carpet filthy?<br>Julie: <strong>It was dirty.</strong>",
  kresponsequestion: "Does Julie mean that her carpet was filthy?",
  iresponsequestion: "Does Julie mean that his carpet was filthy?"}
  ...
  question: "Did Julie notice that her aparment was not clean?",  
  speakerutt: "then asks Julie:", 
  kexchange:: "Mike: Was your carpet dirty?<br>Julie: <strong>It was filthy.</strong>",
  iexchange:: "Stan: Was his carpet dirty?<br>Julie: <strong>It was filthy.</strong>",
  kresponsequestion: "Does Julie mean that her carpet was dirty?",
  iresponsequestion: "Does Julie mean that his carpet was dirty?"}
  ...
  speakerutt: "then asks Julie:", 
  kexchange:: "Is your blog post hilarious?<br>Julie: <strong>It’s funny.</strong>",
  iexchange:: "Is his blog post hilarious?<br>Julie: <strong>It’s funny.</strong>",,
  kresponsequestion: "Does Julie mean that her blog post was hilarious?",
  iresponsequestion: "Does Julie mean that his blog post was hilarious?"}
...
{audio_filler: "hilarious",
  ...
  question: "Is Julie writing a blog?",  
  speakerutt: "then asks Julie:", 
  kexchange:: "Is your blog post funny?<br>Julie: <strong>It’s hilarious.</strong>",
  iexchange:: "Is his blog post funny?<br>Julie: <strong>It’s hilarious.</strong>",,
  kresponsequestion: "Does Julie mean that her blog post was funny?",
  iresponsequestion: "Does Julie mean that his blog post was funny?"}
...
//target good-looking
  ...
  speakerutt: "then asks Julie:", 
  kexchange:: "Mike: Was your date hot?<br>Julie: <strong>He was good-looking.</strong>",
  iexchange:: "Stan: Was his date hot?<br>Julie: <strong>He was good-looking.</strong>",
  kresponsequestion: "Does Julie mean that her date was hot?",
  iresponsequestion: "Does Julie mean that his date was hot?"}
...
// filler hot
  ...
  question: "Did Julie recently go on a date?",  
  speakerutt: "then asks Julie:", 
  kexchange:: "Mike: Was your date good-looking?<br>Julie: <strong>He was hot.</strong>",
  iexchange:: "Stan: Was his date good-looking?<br>Julie: <strong>He was hot.</strong>",
  kresponsequestion: "Does Julie mean that her date was good-looking?",
  iresponsequestion: "Does Julie mean that his date was good-looking?"}
...
// target intelligent
  ...
  speakerutt: "then asks Julie:", 
  kexchange:: "Mike: Is your professor brilliant<br>Julie: <strong>She's intelligent.</strong>",
  iexchange:: "Stan: Is his professor brilliant?<br>Julie: <strong>She's intelligent.</strong>",
  kresponsequestion: "Does Julie mean that her professor was brilliant?",
  iresponsequestion: "Does Julie mean that his professor was brilliant?"}
...
// filler brilliant
  ...
  question: "Is Julie taking computer programming classes?",  
  speakerutt: "then asks Julie:", 
  kexchange:: "Mike: Is your professor intelligent<br>Julie: <strong>She's brilliant.</strong>",
  iexchange:: "Stan: Is his professor intelligent?<br>Julie: <strong>She's brilliant.</strong>",
  kresponsequestion: "Does Julie mean that her professor was intelligent?",
  iresponsequestion: "Does Julie mean that his professor was intelligent?"}
...
// target intimidating
  ...
  speakerutt: "then asks Julie:", 
  kexchange:: "Mike: Was your opponent terrifying?<br>Julie: <strong>He was intimidating.</strong>",
  iexchange:: "Stan: Was his opponent terrifying?<br>Julie: <strong>He was intimidating.</strong>",
  kresponsequestion: "Does Julie mean that her opponent was terrifying?",
  iresponsequestion: "Does Julie mean that his opponent was terrifying?"}
...
{audio_filler: "terrifying",
  ...
  question: "Did Julie recently have a kickboxing match?",  
  speakerutt: "then asks Julie:", 
  kexchange:: "Mike: Was your opponent intimidating?<br>Julie: <strong>He was terrifying.</strong>",
  iexchange:: "Stan: Was his opponent intimidating?<br>Julie: <strong>He was terrifying.</strong>",
  kresponsequestion: "Does Julie mean that her opponent was intimidating?",
  iresponsequestion: "Does Julie mean that his opponent was intimidating?"}
  ...
  speakerutt: "then asks Julie:", 
  kexchange:: "Mike: Was your speech impeccable?<br>Julie: <strong>It was polished.</strong>",
  iexchange:: "Stan: Was his speech impeccable?<br>Julie: <strong>It was polished.</strong>",
  kresponsequestion: "Does Julie mean that her speech was impeccable?",
  iresponsequestion: "Does Julie mean that his speech was impeccable?"}
  ...
  question: "Did Julie give a speech?",  
  speakerutt: "then asks Julie:", 
  kexchange:: "Mike: Was your speech polished?<br>Julie: <strong>It was impeccable.</strong>",
  iexchange:: "Stan: Was his speech polished?<br>Julie: <strong>It was impeccable.</strong>",
  kresponsequestion: "Does Julie mean that her speech was polished?",
  iresponsequestion: "Does Julie mean that his speech was polished?"}
 ...
 // target prominent
  ...
  speakerutt: "then asks Julie:", 
  kexchange:: "Mike: Is your boss famous?<br>Julie: <strong>She's prominent.</strong>",
  iexchange:: "Stan: Is his boss famous?<br>Julie: <strong>She's prominent.</strong>",
  kresponsequestion: "Does Julie mean that her boss is famous?",
  iresponsequestion: "Does Julie mean that his boss is famous?"}
...
// filler famous
  ...
  question: "Was Julie anxious about working at the law firm?",  
  speakerutt: "then asks Julie:", 
  kexchange:: "Mike: Is your boss promiment?<br>Julie: <strong>She's famous.</strong>",
  iexchange:: "Stan: Is his boss prominent?<br>Julie: <strong>She's famous.</strong>",
  kresponsequestion: "Does Julie mean that her boss is prominent?",
  iresponsequestion: "Does Julie mean that his boss is prominent?"}
...
// target serious
  ...
  speakerutt: "then asks Julie:", 
  kexchange:: "Mike: Was your illness life-threatening?<br>Julie: <strong>It was serious.</strong>",
  iexchange:: "Stan: Was his illness life-threatening?<br>Julie: <strong>It was serious.</strong>",
  kresponsequestion: "Does Julie mean that her illness was life-threatening",
  iresponsequestion: "Does Julie mean that his illness was life-threatening"}

  // filler life-threatening
  {audio_target: "serious",
  audio_filler: "life-threatening",
  icontext: "After not hearing from her friend Mike for a few weeks, Julie writes him on Facebook Messenger. Mike said that he was sick and was in the hospital, but didn’t provide that much information. Later, Julie hangs out with her boyfriend Stan and tell him that she had just heard from Mikeand explains what she found out.", 
  kcontext: "Julie had started having headaches and felt week. She found herself stuck in bed and had her roomate take her to the emergency room one night. It took the doctors several weeks to diagnose her with mono and provide a treatment for her. After she feels better, she meets up with her friend Mike and tells him what happened.", 
  question: "Did Julie go to the hospital?",  
  speakerutt: "then asks Julie:", 
  kexchange:: "Mike: Was your illness serious?<br>Julie: <strong>It was life-threatening.</strong>",
  iexchange:: "Stan: Was his illness serious?<br>Julie: <strong>It was life-threatening.</strong>",
  kresponsequestion: "Does Julie mean that her illness was serious",
  iresponsequestion: "Does Julie mean that his illness was serious"}
...
// target shabby
  ...
  speakerutt: "then asks Julie:", 
  kexchange:: "Mike: Is your house decrepit?<br>Julie: <strong>It's shabby.</strong>",
  iexchange:: "Stan: Is his house decrepit?<br>Julie: <strong>It's shabby.</strong>",
  kresponsequestion: "Does Julie mean that her house is decrepit?",
  iresponsequestion: "Does Julie mean that his house is decrepit?"}

// filler decrepit
  {audio_filler: "decrepit",
  icontext: "Several months after his uncle passed away, Mike goes to see his house in the next state over and help prepare it to be sold. On his way back, he sees his friend Julie at the airport and briefly tells her about it. Upon getting home, Julie tell to her boyfriend Stan what she gathered about Mike's uncle's house.", 
  kcontext: "Several months after her dad passed away, Julie inherited her dad's lake house. She hadn't seen it in several years and goes on a trip to check it out. Upon getting back, she hangs out with her friend Mike and tells him about the state that her newly acquired house is in.", 
  question: "Did Julie go on a trip?",  
  speakerutt: "then asks Julie:", 
  kexchange:: "Mike: Is your house shabby?<br>Julie: <strong>It's decrepit.</strong>",
  iexchange:: "Stan: Is his house shabby?<br>Julie: <strong>It's decrepit.</strong>",
  kresponsequestion: "Does Julie mean that her house is shabby?",
  iresponsequestion: "Does Julie mean that his house is shabby?"}
...
{audio_target: "strenuous",
  ...
  speakerutt: "then asks Julie:", 
  kexchange:: "Mike: Was your hike exhausting?<br>Julie: <strong>It was strenuous.</strong>",
  iexchange:: "Mike: Was your hike exhausting?<br>Julie: <strong>It was strenuous.</strong>”,
  kresponsequestion: "Does Julie mean that her hike was exhausting?",
  iresponsequestion: "Does Julie mean that his hike was exhausting?"}
...
{audio_filler: "exhausting",
  ...
  question: "Did Julie go on a hike?",  
  speakerutt: "then asks Julie:", 
  kexchange:: "Mike: Was your hike strenuous?<br>Julie: <strong>It was exhausting.</strong>",
  iexchange:: "Mike: Was your hike strenuous?<br>Julie: <strong>It was exhausting.</strong>”,
  kresponsequestion: "Does Julie mean that her hike was strenuous?",
  iresponsequestion: "Does Julie mean that his hike was strenuous?"}
...
// target ugly
  ...
  speakerutt: "then asks Julie:", 
  kexchange:: "Mike: Was your bridesmaid dress hideous?<br>Julie: <strong>It was ugly.</strong>",
  iexchange:: "Stan: Was his bridesmaid dress hideous?<br>Julie: <strong>It was ugly.</strong>",
  kresponsequestion: "Does Julie mean that her bridesmaid dress was hideous?",
  iresponsequestion: "Does Julie mean that his bridesmaid dress was hideous?"}
  ...
  question: "Did Julie pick out her dress for the wedding?",  
  speakerutt: "then asks Julie:", 
  kexchange:: "Mike: Was your bridesmaid dress ugly?<br>Julie: <strong>It was hideous.</strong>",
  iexchange:: "Stan: Was his bridesmaid dress ugly?<br>Julie: <strong>It was hideous.</strong>",
  kresponsequestion: "Does Julie mean that her bridesmaid dress was ugly?",
  iresponsequestion: "Does Julie mean that his bridesmaid dress was ugly?"}
...
// target understandable
  ...
  speakerutt: "then asks Julie:", 
  kexchange:: "Mike: Was your interview articulate?<br>Julie: <strong>It was understandable.</strong>",
  iexchange:: "Stan: Was his interview articulate?<br>Julie: <strong>It was understandable.</strong>",
  kresponsequestion: "Does Julie mean that her interview was articulate?",
  iresponsequestion: "Does Julie mean that his interview was articulate?"}

  // filler articulate
  {audio_filler: "articulate",
  icontext: "Mike had an important interview at for a job in communications at a pharmaceutical company. As part of his interview, Mike had to give a speech explaining complicated scientifc findings as part of a mock press conference. She had given Mike some tips about presentations a couple of weeks earlier and was interested in how it went. She texted Mike after the interview and he said it went well. Later, when Julie gets home, she tells her boyfriend Stan about her brief chat with Mike", 
  kcontext: "Julie had an important interview at at for a job in communications at a pharmaceutical company. As part of her interview, Julie had to give a speech explaining complicated scientifc findings as part of a mock press conference. After the interview, she met up with friend Mike, who had helped her prepare for the interview, for a coffee and told him how her interview went. ", 
  question: "Did Julie pick out her dress for the wedding?",  
  speakerutt: "then asks Julie:", 
  kexchange:: "Mike: Was your interview understandable?<br>Julie: <strong>It was articulate.</strong>",
  iexchange:: "Stan: Was his interview understandable?<br>Julie: <strong>It was articulate.</strong>",
  kresponsequestion: "Does Julie mean that her interview was understandable?",
  iresponsequestion: "Does Julie mean that his interview was understandable?"}
...
// target unpleasant
  ...
  question: "Did Julie give a talk about scientific findings?",  
  speakerutt: "then asks Julie:", 
  kexchange:: "Mike: Was your bathroom disgusting?<br>Julie: <strong>It was unpleasant.</strong>",
  iexchange:: "Stan: Was his bathroom disgusting?<br>Julie: <strong>It was unpleasant.</strong>",
  kresponsequestion: "Does Julie mean that her bathroom was disgusting?",
  iresponsequestion: "Does Julie mean that his bathroom was disgusting?"}
  ...
  question: "Did Julie give a talk about scientific findings?",  
  speakerutt: "then asks Julie:", 
  kexchange:: "Mike: Was your bathroom unpleasant?<br>Julie: <strong>It was disgusting.</strong>",
  iexchange:: "Stan: Was his bathroom unpleasant?<br>Julie: <strong>It was disgusting.</strong>",
  kresponsequestion: "Does Julie mean that her bathroom was unpleasant?",
  iresponsequestion: "Does Julie mean that his bathroom was unpleasant?"}

  // control expensive
{audio_target: "expensive",
  ...
  speakerutt: "then asks Julie:", 
  kexchange:: "Mike: Was your cellphone plan cheap?<br>Julie: <strong>It was expensive.</strong>",
  iexchange:: "Stan: Was his cellphone plan cheap?<br>Julie: <strong>It was expensive.</strong>",
  kresponsequestion: "Does Julie mean that her cellphone plan was cheap?",
  iresponsequestion: "Does Julie mean that his cellphone plan was cheap?"}

   

 // control lethargic
{audio_target: "lethargic",
  ...
  speakerutt: "then asks Julie:", 
  kexchange:: "Mike: Is your boss energetic?<br>Julie: <strong>He's lethargic.</strong>",
  iexchange:: "Stan: Is his boss energetic?<br>Julie: <strong>He's lethargic.</strong>",
  kresponsequestion: "Does Julie mean that her boss is energetic?",
  iresponsequestion: "Does Julie mean that his boss is energetic?"}

  // control respectful
{audio_target: "respectful",
  ...
  speakerutt: "then asks Julie:", 
  kexchange:: "Mike: Was your brother rude?<br>Julie: <strong>He was respectful.</strong>",
  iexchange:: "Stan: Was his brother rude?<br>Julie: <strong>He was respectful.</strong>",
  kresponsequestion: "Does Julie mean that her brother is rude?",
  iresponsequestion: "Does Julie mean that his brother is rude?"}
...
{audio_target: "tiny",
  ...
  speakerutt: "then asks Julie:", 
  kexchange:: "Mike: Was your umbrella big?<br>Julie: <strong>It was tiny.</strong>",
  iexchange:: "Stan: Was his umbrella big??<br>Julie: <strong>It was tiny.</strong>",
  kresponsequestion: "Does Julie mean that her umbrella was big?",
  iresponsequestion: "Does Julie mean that his umbrella was big?"}
...
{audio_target: "heavy",
  ...
  question: "Did Julie need an umbrella at the festival?",  
  speakerutt: "then asks Julie:", 
  kexchange:: "Mike: Was your suitcase light?<br>Julie: <strong>It was heavy.</strong>",
  iexchange:: "Stan: Was his suitcase light?<br>Julie: <strong>It was heavy.</strong>",
  kresponsequestion: "Does Julie mean that her suitcase was light?",
  iresponsequestion: "Does Julie mean that his suitcase was light?"}
...
{audio_target: "guilty",
  ...
  kresponsequestion: "Does Julie mean that her sister was innocent?",
  iresponsequestion: "Does Julie mean that his sister was innocent?"}
